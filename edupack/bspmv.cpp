                 ...
                 int *destprocu, int *destindu )
{
    ...
    */
    ...
    bsp_push_reg( tmpprocv, np * SZINT );
    tmpindv = vecalloci( np );
    bsp_push_reg( tmpindv, np * SZINT );
    tmpprocu = vecalloci( np );
    bsp_push_reg( tmpprocu, np * SZINT );
    tmpindu = vecalloci( np );
    bsp_push_reg( tmpindu, np * SZINT );
    bsp_sync();
    ...
    bsp_pop_reg( tmpindu );
    bsp_pop_reg( tmpprocu );
    bsp_pop_reg( tmpindv );
    bsp_pop_reg( tmpprocv );
    bsp_sync();
